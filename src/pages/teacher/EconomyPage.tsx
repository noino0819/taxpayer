  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <p className="text-sm text-text-secondary font-bold">학급 코스피</p>
      ...
      <Card>
        <h3 className="font-bold mb-4">주식 종목 현황</h3>
          ...
          <div className="space-y-3">
            {stocks.map((stock) => {
              ...
              const changePercent = stock.previous_price > 0
                ...
                : '0.0'
              return (
                <div key={stock.id} className="flex items-center justify-between p-3 border-b border-border/50 last:border-0">
                  <div>
